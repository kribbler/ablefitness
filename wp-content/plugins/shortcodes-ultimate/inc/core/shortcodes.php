	...
	public static function carousel( $atts = null, $content = null ) {
		...
		if ( count( $slides ) ) {
			...
			foreach ( (array) $slides as $slide ) {
				...
				if ( $slide['link'] ) {
					$return .= '<a class="carousel_image" href="' . $slide['link'] . '"' . $target . '><img src="' . $slide['image'] . '" /></a>';
					$return .= '<a class="carousel_post" href="' . $slide['link'] . '"' . $target . '>' . $slide['content'] . '</a>';
				}
				else {
					$return .= '<div class="hold_image"><img class="carousel_imagex" src="' . $slide['image'] . '" /></div>';
